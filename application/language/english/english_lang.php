...
$lang['invoice_pdf_heading']                   = 'CONTRACT';
...
$lang['invoice_data_date']                     = 'Contract Date:';
$lang['invoice_data_duedate']                  = 'Due Date:';
$lang['invoice_received_payments']             = 'Transactions';
$lang['invoice_no_payments_found']             = 'No payments found for this contract';
...
$lang['client_invoices_tab']                     = 'Contracts';
...
$lang['email_template_invoices_fields_heading'] = 'Contracts';
...
# Invoice Items
$lang['invoice_items']                     = 'Contract Items';
$lang['invoice_item']                      = 'Contract Item';
$lang['new_invoice_item']                  = 'New Item';
$lang['invoice_item_lowercase']            = 'Contract item';
...
# Invoices
$lang['invoices']                                = 'Contracts';
$lang['invoice']                                 = 'Contract';
$lang['invoice_lowercase']                       = 'Contract';
$lang['create_new_invoice']                      = 'Create New Contract';
$lang['view_invoice']                            = 'View Contract';
$lang['invoice_payment_recorded']                = 'Contract Payment Recorded';
$lang['invoice_payment_record_failed']           = 'Failed to Record Contract Payment';
$lang['invoice_sent_to_client_success']          = 'The contact is sent successfully to the client';
$lang['invoice_sent_to_client_fail']             = 'Problem while sending the contact';
$lang['invoice_reminder_send_problem']           = 'Problem sending contract overdue reminder';
$lang['invoice_overdue_reminder_sent']           = 'Contract Overdue Reminder Successfully Sent';
$lang['invoice_details']                         = 'Contract Details';
$lang['invoice_view']                            = 'View Contract';
$lang['invoice_select_customer']                 = 'Customer';
$lang['invoice_add_edit_number']                 = 'Contract Number';
$lang['invoice_add_edit_date']                   = 'Contract Date';
...
$lang['edit_invoice_tooltip']                    = 'Edit Contract';
$lang['delete_invoice_tooltip']                  = 'Delete Contract. Note: All payments regarding to this contract will be deleted (if any).';
$lang['invoice_sent_to_email_tooltip']           = 'Send to Email';
$lang['invoice_already_send_to_client_tooltip']  = 'This contract is already sent to the client %s';
...
$lang['invoice_send_to_client_modal_heading']    = 'Send contract to client';
$lang['invoice_send_to_client_attach_pdf']       = 'Attach contract PDF';
$lang['invoice_send_to_client_preview_template'] = 'Preview Email Template';
$lang['invoice_dt_table_heading_number']         = 'Contract #';
...
$lang['no_payments_found']                       = 'No Payments found for this contract';
...
$lang['payments_table_invoicenumber_heading'] = 'Contract #';
...
$lang['payment_edit_for_invoice']             = 'Payment for Contract';
...
$lang['settings_cron_send_overdue_reminder']                       = 'Send contract overdue reminder';
$lang['settings_cron_send_overdue_reminder_tooltip']               = 'Send overdue email to client when contract status updated to overdue from Cron Job';
...
$lang['settings_sales_invoice_prefix']                             = 'Contract Number Prefix';
...
$lang['settings_sales_require_client_logged_in_to_view_invoice']   = 'Require client to be logged in to view contract';
$lang['settings_sales_next_invoice_number']                        = 'Next Contract Number';
$lang['settings_sales_next_invoice_number_tooltip']                = 'Set this field to 1 if you want to start from beginning';
$lang['settings_sales_decrement_invoice_number_on_delete']         = 'Decrement contract number on delete';
$lang['settings_sales_decrement_invoice_number_on_delete_tooltip'] = 'Do you want to decrement the contract number when the last invoice is deleted? eq. If is set this option to YES and before invoice delete the next invoice number is 15 the next invoice number will decrement to 14. If is set to NO the number will remain to 15.  If you have setup delete only on last invoice to NO you should set this option to NO too to keep the next invoice number not decremented.';
$lang['settings_sales_invoice_number_format']                      = 'Contract Number Format';
...
$lang['settings_sales_company_info_note']                          = 'These information will be displayed on contracts/estimates/payments and other PDF documents where company info is required';
...
$lang['user_sent_overdue_reminder'] = '%s sent contract overdue reminder';
...
# Home
$lang['clients_quick_invoice_info']           = 'Quick Contracts Info';
...
$lang['clients_my_invoices']               = 'Contracts';
$lang['clients_invoice_dt_number']         = 'Contract #';
...
$lang['clients_nav_invoices']  = 'Contracts';
...
$lang['payment_table_invoice_number']                  = 'Contract Number';
$lang['payment_table_invoice_date']                    = 'Contract Date';
$lang['payment_table_invoice_amount_total']            = 'Contract Amount';
...
# Invoices
$lang['view_invoice_as_customer_tooltip']                                     = 'View contract as customer';
$lang['invoice_add_edit_recurring']                                           = 'Recurring Contract?';
...
$lang['invoices_list_not_have_payment']                                       = 'Contracts with no payment records';
$lang['invoices_list_recurring']                                              = 'Recurring Contracts';
$lang['invoices_list_made_payment_by']                                        = 'Made Payment by %s';
$lang['invoices_create_invoice_from_recurring_only_on_paid_invoices']         = 'Create new contract from recurring contract only if the contract is with status paid?';
$lang['invoices_create_invoice_from_recurring_only_on_paid_invoices_tooltip'] = 'If this field is set to YES and the recurring contracts is not with status PAID, the new contract will NOT be created.';
$lang['view_invoice_pdf_link_pay']                                            = 'Pay Contract';

# Payment modes
$lang['payment_mode_add_edit_description']         = 'Bank Accounts / Description';
$lang['payment_mode_add_edit_description_tooltip'] = 'You can set here bank accounts information. Will be shown on HTML Contract';
...
# Payments
$lang['payment_for_invoice'] = 'Payment for Contract';
...
$lang['invoice_add_edit_allowed_payment_modes']           = 'Allowed payment modes for this contract';
$lang['invoice_add_edit_recurring_invoices_from_invoice'] = 'Created contracts from this recurring contract';
...
$lang['settings_delete_only_on_last_invoice']                       = 'Delete contract allowed only on last contract';
...
$lang['settings_delete_only_on_last_estimate']                      = 'Delete estimate allowed only on last contract';
...
$lang['settings_sales_heading_invoice']                             = 'Contract';
$lang['settings_sales_heading_estimates']                           = 'Estimates';
$lang['settings_sales_cron_invoice_heading']                        = 'Contract';
...
$lang['settings_estimate_auto_convert_to_invoice_on_client_accept']   = 'Auto convert the estimate to contract after client accept';
...
$lang['estimate_invoiced_date']                   = 'Estimate Contracted on %s';
...
$lang['estimate_convert_to_invoice']              = 'Convert to Contract';
...
$lang['clients_estimate_invoiced_successfully'] = 'Thank you for accepting the estimate. Please review the created contract for the estimate';
...
$lang['calendar_invoice']           = 'Contract';
...
# Settings
$lang['settings_show_sale_agent_on_invoices']       = 'Show Sale Agent On Contract';
...
$lang['invoice_marked_as_sent']        = 'Contract marked as sent successfully';
$lang['invoice_marked_as_sent_failed'] = 'Failed to mark contract as sent';
...
$lang['expense_converted_to_invoice']                 = 'Expense successfully converted to contract';
$lang['expense_converted_to_invoice_fail']            = 'Failed to convert this expense to contract check error log.';
...
$lang['expenses_list_invoiced']                       = 'Contracted';
$lang['expenses_list_unbilled']                       = 'Not Contracted';
$lang['expenses_list_recurring']                      = 'Recurring';
$lang['expense_invoice_delete_not_allowed']           = 'You cant delete this expense. The expense is already Contracted.';
$lang['expense_convert_to_invoice']                   = 'Convert To Contract';
$lang['expense_edit']                                 = 'Edit Expense';
$lang['expense_delete']                               = 'Delete';
$lang['expense_copy']                                 = 'Copy';
$lang['expense_invoice_not_created']                  = 'Contract Not Created';
$lang['expense_billed']                               = 'Billed';
$lang['expense_not_billed']                           = 'Contract Not Paid';
...
$lang['expense_already_invoiced']                     = 'This expense is already contracted';
$lang['expense_recurring_auto_create_invoice']        = 'Auto Create Contract';
$lang['expense_recurring_send_custom_on_renew']       = 'Send the contract to customer email when expense re-created';
$lang['expense_recurring_autocreate_invoice_tooltip'] = 'If this option is checked the contract for the customer will be auto created when the expense will be renewed.';
...
$lang['custom_field_invoice']     = 'Contract';
...
# Estimates
$lang['estimate_convert_to_invoice_successfully'] = 'Estimate converted to contract successfully';
...
$lang['invoice_copy']              = 'Copy Contract';
$lang['invoice_copy_success']      = 'Contract copied successfully';
$lang['invoice_copy_fail']         = 'Failed to copy contract';
$lang['invoice_due_after_help']    = 'Set zero to avoid calculation';
$lang['show_shipping_on_invoice']  = 'Show shipping details in contract';

# Estimates
$lang['show_shipping_on_estimate']         = 'Show shipping details in estimate';
$lang['is_invoiced_estimate_delete_error'] = 'This estimate is contracted. You cant delete the estimate';
...
$lang['customer_update_address_info_on_invoices']              = 'Update the shipping/billing info on all previous contracts/estimates';
...
# Expenses
$lang['expense_list_invoice']  = 'Contracted';
$lang['expense_list_billed']   = 'Billed';
$lang['expense_list_unbilled'] = 'Not Contracted';
...
$lang['settings_sales_invoice_due_after']                                    = 'Contract due after (days)';
...
$lang['show_invoices_on_calendar']                                           = 'Contracts';
...
$lang['bulk_export_pdf_invoices']      = 'Contracts';
...
$lang['customer_permission_invoice']  = 'Contracts';
...
$lang['show_invoice_estimate_status_on_pdf']                      = 'Show contract/estimate status on PDF';
...
$lang['proposal_convert_invoice']               = 'Contract';
$lang['proposal_convert_to_estimate']           = 'Convert to Estimate';
$lang['proposal_convert_to_invoice']            = 'Convert to Contract';
...
$lang['proposal_converted_to_invoice_success']  = 'Proposal converted to contract successfully';
$lang['proposal_converted_to_estimate_fail']    = 'Failed to convert proposal to estimate';
$lang['proposal_converted_to_invoice_fail']     = 'Failed to convert proposal to contract';
...
$lang['not_recurring_invoices_cron_activity_heading']             = 'Recurring Contracts Cron Job Activity';
...
$lang['not_invoice_created']                                      = 'Contract Created:';
$lang['not_invoice_renewed']                                      = 'Renewed Contract:';
$lang['not_expense_renewed']                                      = 'Renewed Expense:';
$lang['not_invoice_sent_to_customer']                             = 'Contract Sent to Customer: %s';
$lang['not_invoice_sent_yes']                                     = 'Yes';
$lang['not_invoice_sent_not']                                     = 'No';
$lang['not_action_taken_from_recurring_invoice']                  = 'Action taken from recurring contract:';
...
$lang['estimate_activity_converted']                              = 'converted this estimate to contract.<br /> %s';
...
$lang['invoice_activity_number_changed']                          = 'Contract number changed from %s to %s';
...
$lang['estimate_activity_client_accepted_and_converted']          = 'Customer accepted this estimate. Estimate is converted to contract with number %s';
...
$lang['invoice_activity_status_updated']                          = 'Contract status updated from %s to %s';
$lang['invoice_activity_created']                                 = 'created the contract';
$lang['invoice_activity_from_expense']                            = 'converted to contract from expense';
$lang['invoice_activity_recurring_created']                       = '[Recurring] Contract created by CRON';
$lang['invoice_activity_recurring_from_expense_created']          = '[Contract From Expense] Contract created by CRON';
$lang['invoice_activity_sent_to_client_cron']                     = 'Contract sent to customer by CRON';
$lang['invoice_activity_sent_to_client']                          = 'sent contract to customer';
$lang['invoice_activity_marked_as_sent']                          = 'marked contract as sent';
$lang['invoice_activity_payment_deleted']                         = 'deleted payment for the contract. Payment #%s, total amount %s';
$lang['invoice_activity_payment_made_by_client']                  = 'Client made payment for the contract from total <b>%s</b> - %s';
...
$lang['settings_amount_to_words_desc']     = 'Output total amount to words in contract/estimate';
...
$lang['report_invoice_number']            = 'Contract #';
...
$lang['home_invoice_overview']        = 'Contract overview';
...
# General
$lang['zip_invoices']         = 'Zip Contracts';
...
$lang['task_is_billed']         = 'This task is billed on contract with number %s';
...
$lang['project_invoiced_successfully']                       = 'Project Contracted Successfully';
...
$lang['project_invoices']                                    = 'Contracts';
$lang['total_logged_hours_by_staff']                         = 'Total Logged Time';
$lang['invoice_project']                                     = 'Contract Project';
$lang['invoice_project_info']                                = 'Project Contract Info';
...
$lang['project_activity_invoiced_project']             = 'Contracted project';
...
$lang['sales_report_cancelled_invoices_not_included']          = 'Cancelled contracts are excluded from the report';
$lang['invoices_merge_cancel_merged_invoices']                 = 'Mark merged contracts as cancelled instead of deleting';
$lang['invoice_marked_as_cancelled_successfully']              = 'Contract marked as cancelled successfully';
$lang['invoice_unmarked_as_cancelled']                         = 'Contract unmarked as cancelled successfully';
...
$lang['invoice_project_see_billed_tasks']                      = 'See tasks that will be billed on this contract';
$lang['invoice_project_all_billable_tasks_marked_as_finished'] = 'All billed tasks will be marked as finished';
$lang['invoice_project_nothing_to_bill']                       = 'No tasks to bill. Feel free to add whatever you want in the contract items.';
...
$lang['project_invoice_timers_started']                        = 'Task timers found running on billable tasks, contract cannot be created. Please stop task timers to create contract.';
...
$lang['invoices_available_for_merging']                        = 'Contracts Available for Merging';
$lang['invoices_merge_discount']                               = 'You will have to apply discount of total %s manually to this contract';
$lang['invoice_merge_number_warning']                          = 'Merging contracts will create gaps in contract numbers. Please do not merge contracts if you want no gaps in your contract history. You also have the option of manually adjusting contract numbers if you want to fill the gaps.';
...
$lang['invoice_set_reminder_title']              = 'Set Contract Reminder';
...
$lang['invoice_project_see_billed_expenses']              = 'See expenses that will be billed on this contract';
...
$lang['notification_when_customer_pay_invoice'] = 'Receive notification when customer pay contract (built-in)';
$lang['not_invoice_payment_recorded']           = 'New contract payment - %s';
...
$lang['changing_items_affect_warning']          = 'Changing item info won\'t affect on the created contracts/estimates/proposals/credit notes.';
...
$lang['not_estimate_invoice_deleted']           = 'deleted the created contract';
$lang['not_task_new_comment']                   = 'commented on task %s';

# Version 1.1.8
$lang['invoice_number_exists']                  = 'This contract number exists for the ongoing year.';
...
$lang['invoice_activity_marked_as_cancelled']   = 'marked contract as cancelled';
$lang['invoice_activity_unmarked_as_cancelled'] = 'unmarked contract as cancelled';
...
$lang['invoice_report']                         = 'Contracts Report';
...
$lang['invoice_files']                            = 'Contract Files';
$lang['estimate_files']                           = 'Estimate Files';
$lang['proposal_files']                           = 'Proposal Files';
$lang['invoices_awaiting_payment']                = 'Contracts Awaiting Payment';
$lang['tasks_not_finished']                       = 'Tasks Not Finished';
$lang['outstanding_invoices']                     = 'Outstanding Contracts';
$lang['past_due_invoices']                        = 'Past Due Contracts';
$lang['paid_invoices']                            = 'Paid Contracts';
...
$lang['projects_total_invoices_created']                    = 'Total contracts created';
$lang['do_not_send_invoice_payment_email_template_contact'] = 'Do not send contract payment recorded email to customer contacts';
...
$lang['cancel_overdue_reminders_invoice']                   = 'Prevent sending overdue reminders for this contract';
$lang['customer_shipping_address_notice']                   = 'Do not fill shipping address information if you won\'t use shipping address on customer contracts';
...
$lang['exclude_invoices_draft_from_client_area']            = 'Exclude contracts with draft status from customers area';
$lang['invoice_draft_status_info']                          = 'This contract is with status Draft, status will be auto changed when you send the contract to the customer or mark as sent.';
...
$lang['payment_mode_invoices_only']                = 'Contracts Only';
...
# Version 1.2.8
$lang['show_transactions_on_invoice_pdf']            = 'Show contract payments (transactions) on PDF';
...
$lang['show_on_invoice_on_pdf']                      = 'Show %s on Contract PDF';
$lang['show_pay_link_to_invoice_pdf']                = 'Show Pay Contract link to PDF (Not applied if contract status is Cancelled)';
...
$lang['invoice_is_overdue']                   = 'This contract is overdue by %s days';
...
$lang['next_invoice_date']                                  = 'Next Contract Date: %s';
$lang['next_expense_date']                                  = 'Next Expense Date: %s';
$lang['invoice_recurring_from']                             = 'This contract is created from recurring contract with number: %s';
$lang['expense_recurring_from']                             = 'This expense is created from the following recurring expense: %s';
$lang['child_invoices']                                     = 'Child Contracts';
...
$lang['permission_payments_based_on_invoices']              = 'Based on contracts VIEW (Own) permission';
...
$lang['settings_paymentmethod_default_selected_on_invoice'] = 'Selected by default on contract';
...
$lang['estimate_invoiced']                                  = 'Contracted';
...
$lang['invoice_not_found']                                  = 'Contract not found';
...
$lang['invoice_activity_auto_converted_from_estimate']      = 'Contract auto created from estimate with number %s';
...
$lang['inv_hour_of_day_perform_auto_operations_help']       = 'Used for recurring contracts, overdue notices etc..';
...
$lang['recurring_invoice_draft_notice']           = 'This contract is with status draft, you need to mark this contract as sent. Recurring contracts with status draft won\'t be recreated by cron job.';
...
# Version 1.8.0
$lang['not_customer_viewed_invoice']                         = 'An contract with number %s has been viewed';
...
$lang['invoiced_amount']                                     = 'Contracted Amount';
$lang['amount_paid']                                         = 'Amount Paid';
$lang['statement_from_to']                                   = '%s To %s';
$lang['customer_statement_info']                             = 'Showing all contracts and payments between %s and %s';
...
$lang['statement_invoice_details']                           = 'Contract %s - due on %s';
$lang['statement_payment_details']                           = 'Payment (%s) to contract %s';
...
$lang['estimates_not_invoiced']                              = 'Not Contracted';
...
$lang['item_report_paid_invoices_notice']        = 'Items report is generated only from paid contracts before discounts and taxes.';
...
$lang['show_pdf_signature_invoice']              = 'Show PDF Signature on Contract';
...
$lang['invoice_cancelled_email_disabled']                  = 'Contract is cancelled. Unmark as cancelled to enable email to client';
...
$lang['reccuring_invoice_option_gen_and_send']             = 'Generate and autosend the renewed contract to the customer';
$lang['reccuring_invoice_option_gen_unpaid']               = 'Generate a Unpaid Contract';
$lang['reccuring_invoice_option_gen_draft']                = 'Generate a Draft Contract';
...
$lang['expense_field_billable_help']           = 'If billable, %s can be added to contract long description.';
...
$lang['invoices_credited']                                       = 'Contracts Credited';
...
$lang['invoice_credits_applied']                                 = 'Credits successfully applied to contract';
$lang['applied_credits']                                         = 'Applied Credits';
$lang['credit_amount_bigger_then_invoice_balance']               = 'Total credits amount is bigger then contract balance due';
$lang['credit_amount_bigger_then_credit_note_remaining_credits'] = 'Total credits amount is bigger then remaining credits';
$lang['credited_invoices_not_found']                             = 'Credited Contracts Not Found';
$lang['credit_invoice_number']                                   = 'Contract Number';
...
$lang['confirm_invoice_credits_from_credit_note']                = 'When creating credit note from non paid contract, the credit note amount will get applied for this contract. Are you sure that you want to create the credit note?';
$lang['credit_invoice_date']                                     = 'Contract Date';
$lang['apply_to_invoice']                                        = 'Apply to contract';
$lang['apply_credits_from']                                      = 'Apply Credits From %s';
$lang['credits_successfully_applied_to_invoices']                = 'Contracts credits successfully applied';
...
$lang['credit_note_no_invoices_available']                       = 'There are no available contracts for this customer.';
$lang['show_total_paid_on_invoice']                              = 'Show Total Paid On Contract';
$lang['show_credits_applied_on_invoice']                         = 'Show Credits Applied On Contract';
$lang['show_amount_due_on_invoice']                              = 'Show Amount Due On Contract';
...
$lang['show_project_on_invoice']                  = 'Show Project Name On Contract';
...
$lang['upcoming_invoice']                                       = 'Upcoming Contract';
...
$lang['allow_staff_view_invoices_assigned']                     = 'Allow staff members to view contracts where they are assigned to';
...
$lang['subscription_option_send_invoice']                       = 'Send Contract';
$lang['subscription_option_send_payment_receipt']               = 'Send Payment Receipt';
$lang['subscription_option_send_payment_receipt_and_invoice']   = 'Send Contract and Payment Receipt';
...
$lang['last_invoice_date']      = 'Last Contract Date';
$lang['next_invoice_date_list'] = 'Next Contract Date';
...
$lang['last_child_invoice_date']                                     = 'Last Child Contract Date';
$lang['good_morning']                                                = 'Good Morning';
$lang['good_afternoon']                                              = 'Good Afternoon';
$lang['good_evening']                                                = 'Good Evening';
$lang['description_in_invoice_item']                                 = 'Include description in contract item';
$lang['description_in_invoice_item_help']                            = 'Useful if you want to include additional information on the subscription contract, e.q. what this subscription includes.';
...
$lang['invoice_will_be_sent_at']        = 'Contract will be sent at %s';
...
$lang['invoice_number_not_applied_on_draft']                  = 'If the contract is saved as draft, the number won\'t be applied, instead, the next contract number will be given when the contract is sent to the customer or is marked as sent.';
...
$lang['attach_invoice_to_payment_receipt_email'] = 'Attach contract PDF when sending payment receipt to email';
...
$lang['activity_due_reminder_is_sent']   = '%s sent contract becoming due reminder';
$lang['invoice_due_notice_before']       = 'Send due reminder X days before due date';
$lang['overdue_notices']                 = 'Overdue Notices';
$lang['invoice_overdue_notices_info']    = 'Overdue notices are sent when the contract becomes overdue.';
$lang['due_reminders']                   = 'Due Reminders';
$lang['due_reminders_for_invoices_info'] = 'Due reminders are sent to unpaid and partially paid contracts as reminder to the customer to pay the invoice before is due.';
...
$lang['batch_payments_table_invoice_number_heading']      = 'Contract Number';
...
$lang['batch_payments_table_invoice_balance_due']         = 'Contract Balance Due';
$lang['add_batch_payments']                               = 'Add Payments';
$lang['batch_payment_filter_by_customer']                 = 'Filter contracts by customer';
$lang['batch_payments']                                   = 'Batch Payments';
$lang['batch_payment_added_successfully']                 = 'You have successfully added %s payments';
$lang['batch_payments_send_invoice_payment_recorded']     = 'Do not send contract payment recorded email to customer contacts';
...
$lang['automatically_set_logged_in_staff_sales_agent_help'] = 'Applicable for: Estimates, contracts, proposal';
...
$lang['payment_attempt_amount']                             = 'Contract Total';
