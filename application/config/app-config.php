...
//define('APP_BASE_URL', 'https://crm.ctc.expert/');
...
*/
define('APP_ENC_KEY', '4af311b627e22df00dbde91d541d0af8');
 ...
 */
define('APP_DB_USERNAME', 'eder_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'OydyFcDCD9GJ?wGE');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'eder_crm_per');
