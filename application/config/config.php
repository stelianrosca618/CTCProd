...
$config['csrf_exclude_uris'] = [
        ...
        'api\/.+',
        'missiveapp/contact_update', 
        'missiveapp/editFixedNote', 
        'missiveapp/addLastNote',
        'missiveapp/loadNewProposalData',
        'missiveapp/get_relation_data',
        'missiveapp/get_relation_data_values',
        'missiveapp/get_relation_data_values/.+',
        'missiveapp/lead_Update',
        'missiveapp/getItems',
        'missiveapp/lead_Create',
        'missiveapp/leadFields_Update',
        'missiveapp/auth'];
