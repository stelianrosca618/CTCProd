    ...
    <div class="row">
        <div class="col-md-8 proposal-left">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <?php if (!empty($proposal->moq)) { ?>
                    <p><strong>MOQ:</strong> <?php echo $proposal->moq; ?></p>
                    <?php } ?>
                </div>
                <div class="col-md-6">
                    <?php if (!empty($proposal->items)) { ?>
                    <p><strong>20 FCL:</strong> <?php echo $proposal->items[0]['fcl_20_container']; ?></p>
                    <?php } ?>
                </div>
                <div class="col-md-6">
                    <?php if (!empty($proposal->quantity_offered)) { ?>
                    <p><strong>Quantity Offered:</strong> <?php echo $proposal->quantity_offered; ?></p>
                    <?php } ?>
                </div>
                <div class="col-md-6">
                    <?php if (!empty($proposal->moq)) { ?>
                    <p><strong>40 FCL:</strong> <?php echo  $proposal->items[0]['fcl_40_container']; ?></p>
                    <?php } ?>
                </div>
            </div>
