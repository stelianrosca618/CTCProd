            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php 
                            $trackEmaill = get_staff_emails('proposal');
                            $output = array_map(function ($object) { return $object['email']; }, $trackEmaill); 
                            $printEmail = implode(',', $output)
                        ?>
                        <?php echo render_input('cc', 'CC', $printEmail); ?>
