...
class Invoices extends AdminController
{
    ...
    public function templates(){
        ...
        $this->load->view('admin/invoices/templates/manage.php', $data);
    }
    public function getTemplate(){
        //print_r($this->input->get());
        $id = $this->input->get('id');
       $templateData = $this->db->where('id', $id)->get(db_prefix().'templates')->result_array();
    ...
    public function addTemplate(){
        ...
        redirect(admin_url('invoices/templates'));
    }
    ...
    public function validate_invoice_number()
    {
        ...
        // BOF VK: Check empty date
        if (empty($date)) {
            $date = date("Y-m-d");
        }
        // EOF VK: Check empty date
